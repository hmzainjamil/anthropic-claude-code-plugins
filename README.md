...
<p align="center">
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/stargazers"><img alt="Stars" src="https://img.shields.io/github/stars/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=ffd700&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/network/members"><img alt="Forks" src="https://img.shields.io/github/forks/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=2ecc71&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/issues"><img alt="Issues" src="https://img.shields.io/github/issues/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=ff6b6b&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/pulls"><img alt="PRs" src="https://img.shields.io/github/issues-pr/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=9b59b6&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/graphs/contributors"><img alt="Contributors" src="https://img.shields.io/github/contributors/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=3498db&logo=github&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/commits/main"><img alt="Commit activity" src="https://img.shields.io/github/commit-activity/m/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=e67e22&logo=git&logoColor=white"/></a>
  <a href="https://github.com/hmzainjamil/anthropic-claude-code-plugins/commits/main"><img alt="Last commit" src="https://img.shields.io/github/last-commit/hmzainjamil/anthropic-claude-code-plugins?style=for-the-badge&labelColor=0d1117&color=8e44ad&logo=git&logoColor=white"/></a>
</p>
...
Claude Code's default frontend output is competent and forgettable. Drop in `frontend-design/SKILL.md` and Claude starts thinking like a senior product designer: design tokens, spacing scales, accessible contrast, motion timing, dark mode parity, real component anatomy.

This repo will grow into a curated marketplace of opinionated plugins. Skills land here only if they actually move the needle on output quality, not because they exist.

Use it as a submodule, copy individual skills into `~/.claude/skills/`, or fork the lot. Zero install ceremony.
...
| | What you get |
|---|---|
| **Plugins** | 1 (and growing) - frontend-design |
| **Format** | Claude Code SKILL.md spec |
| **Install** | `cp -r frontend-design ~/.claude/skills/` |
| **Trigger** | Auto-activates on UI prompts (component, page, layout, button, form) |
| **Scope** | React . Vue . Svelte . plain HTML/CSS |
| **Tokens** | Tailwind v4 vars . CSS custom props |
| **A11y** | WCAG 2.2 AA contrast, focus, motion-reduce |
...
|---|---|---|
| **Design-system mode** | auto | Forces token-based output, no inline hex codes. |
| **Component anatomy** | auto | Generates root/slot/state structure, not flat divs. |
| **Motion timing** | auto | Applies opinionated easing curves and durations. |
| **Dark-mode parity** | auto | Every component ships light+dark from the start. |
| **A11y baked** | auto | ARIA, focus-visible, prefers-reduced-motion. |
| **Copy/paste install** | manual | Drop the folder into `~/.claude/skills/`. |
...
See [issues](https://github.com/hmzainjamil/anthropic-claude-code-plugins/issues) for granular priorities.
...
See [`CHANGELOG.md`](https://github.com/hmzainjamil/anthropic-claude-code-plugins/blob/main/CHANGELOG.md) where applicable. We follow [Keep a Changelog](https://keepachangelog.com/) and [SemVer](https://semver.org/).
...
[GitHub Issues](https://github.com/hmzainjamil/anthropic-claude-code-plugins/issues). Reproduction steps, expected vs. actual, and your Claude Code / Node / Python version help a lot.
</details>
...
<a href="https://star-history.com/#hmzainjamil/anthropic-claude-code-plugins&Date">
  <img src="https://api.star-history.com/svg?repos=hmzainjamil/anthropic-claude-code-plugins&type=Date" alt="Star History"/>
</a>
...
```bash
git clone https://github.com/hmzainjamil/anthropic-claude-code-plugins.git && cd anthropic-claude-code-plugins
...
```
@misc{anthropic_claude_code_plugins_2025,
  author       = {Hamza Zain Jamil},
  title        = {anthropic-claude-code-plugins},
  year         = {2025},
  howpublished = {https://github.com/hmzainjamil/anthropic-claude-code-plugins}
}
```
